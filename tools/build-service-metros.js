...
function estate(m) {
  ...
  const body = `
          ...
          <p>You don't have to drive across ${m.metro} to get this done. In three steps — answer a few questions, let us prepare your documents under Florida law, and sign correctly under Florida's witness and notary rules — you can have a complete plan in place. <a href="/quiz">Take the free Estate Plan Score quiz</a> or <a href="${CALENDLY}" target="_blank" rel="noopener">book a free 20-minute call</a>.</p>
