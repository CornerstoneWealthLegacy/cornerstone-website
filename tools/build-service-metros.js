...
function probate(m) {
  ...
  const faqs = [
    ...
    [`What is summary administration, and does my ${m.metro} estate qualify?`, `Summary administration is Florida's streamlined probate, available when the probate estate — excluding exempt and homestead property — is worth $150,000 or less, or when the decedent has been deceased for more than two years (Fla. Stat. Chapter 735). Many ${m.metro} estates qualify, especially when most assets passed by trust, beneficiary designation, or joint title. Larger estates proceed as formal administration under Chapter 733.`],
