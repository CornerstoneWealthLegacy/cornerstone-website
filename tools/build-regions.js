...
function faqSummary(place) { return `Summary administration is Florida's streamlined probate process, available when the probate estate — excluding exempt and homestead property — is worth $150,000 or less, or when the decedent has been deceased for more than two years (Fla. Stat. Chapter 735). Many estates in ${place} qualify, especially when most assets passed by trust, beneficiary designation, or joint title. Estates that do not qualify proceed as a formal administration under Chapter 733.`; }
