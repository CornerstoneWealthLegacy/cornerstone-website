...
═══════════════════════════════════════════════
DEED SHOP (Florida deed builder — docCategory "deed")
═══════════════════════════════════════════════
The builder also prepares Florida deeds (F.S. Chapter 689). Sections: Deed Type (quitclaim / Lady Bird enhanced life estate / warranty (attorney-only) / into trust / into LLC), Property (address, county, legal description — must be copied EXACTLY from the current deed, not the tax bill; parcel ID), Current Owner (names exactly as on the current deed), Homestead gate (if homestead AND married, the SPOUSE MUST SIGN even if not on title — Fla. Const. Art. X § 4(c); the builder collects the spouse's name for joinder), New Owner (people with vesting choices: joint tenants w/ survivorship, tenants by the entireties for married couples, tenants in common — or trust name/date/trustee, or LLC name), Mortgage check (transfer doesn't move the loan; due-on-sale flags; estate-planning transfers of a residence sit inside Garn-St. Germain protections), Consideration (gift = minimum $0.70 doc stamps on unmortgaged property; sales taxed at $0.70/$100, $0.60 Miami-Dade; MORTGAGED property — including into your own LLC — is generally taxed on the outstanding loan balance).
DOCUMENTS: the deed itself, a Recording Guide with doc-stamp worksheet, and a clerk transmittal letter. Execution: grantor(s) + joining spouse if homestead, TWO witnesses, and a notary (F.S. § 689.01). DIY clients record by mail with the county clerk (~$10 first page + $8.50/page + stamps); attorney tiers are prepared and RECORDED BY MAIL by the firm with government fees at cost.
...
TRADEMARK SERVICE (truesteadlaw.com/trademark — attorney service, no wizard): Registration Package $699 flat + USPTO $350/class — comprehensive search + written opinion, filed by the attorney of record, monitored to registration, non-substantive office actions included (LegalZoom: $899). Search & Opinion $199. Monitoring $149/yr. An LLC protects the name only on Sunbiz; the federal trademark protects it nationwide. 8-14 month timeline; never guaranteed.

SUMMARY ADMINISTRATION (truesteadlaw.com/summary-administration — flat-fee attorney probate service, no wizard): Florida's fast-track probate under Ch. 735. Qualifies when non-exempt probate assets are $150,000 or less (threshold DOUBLED from $75,000 effective July 1, 2026 — estates that needed formal probate last year may qualify now) OR the death was more than 2 years ago at ANY size (creditor claims barred — the standard fix for old un-probated estates and stuck titles). Flat $1,495 without real property / $2,495 with real property (adds the homestead-determination petition that clears title); court filing fees ~$235-$405 by county + recording/publication at cost. No personal representative is appointed; typical 3-8 weeks uncontested. Protected homestead is generally exempt and does NOT count toward the $150,000. Contested estates, unknown heirs, or over-threshold estates convert to formal administration, quoted separately. Very small no-real-estate estates may qualify for free Disposition Without Administration — we tell people when they don't need us. Most firms charge $3,500+.
